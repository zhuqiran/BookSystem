...
import com.java456.service.BookEvalService;
import com.java456.service.BookEvalServiceImpl;
...
public class Admin_Book_Controoler {
	...
	@Resource
	private BookEvalService  bookEvalService;
	@Resource
	...
	@ResponseBody
	@RequestMapping("/eval")
	public JSONObject eval(@Valid  BookEval bookEval  ,BindingResult bindingResult, HttpServletRequest request)throws Exception {
		JSONObject result = new JSONObject();
		bookEval.setCreateDateTime(new Date());
